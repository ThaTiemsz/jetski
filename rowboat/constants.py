import re
import yaml
from disco.types.user import ActivityTypes, Status, UserFlags
...
BADGE_EMOJI = {
    UserFlags.DISCORD_EMPLOYEE: ':staff:699078007192551444',
    UserFlags.DISCORD_PARTNER: ':partner:699078007184425040',
    ...
    UserFlags.BUG_HUNTER_LVL1: ':bughunter1:699078007087824916',
    UserFlags.BUG_HUNTER_LVL2: ':bughunter2:699078007179968613',
    UserFlags.VERIFIED_DEV: ':verified_developer:699078007150739486',
