...
Variables are strings that will automatically be replaced when executing a tag. Global mentions are escaped if the caller doesn't have the MENTION\_EVERYONE permission.
