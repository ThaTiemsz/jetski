    ...
    return (
      <table className="table table-striped table-bordered table-hover">
        ...
        <tbody>
          ...
          <tr>
            <td>Target User</td>
            <td>{inf.user.username}#{inf.user.discriminator.padStart(4, "0")} ({inf.user.id})</td>
          </tr>
          <tr>
            <td>Actor User</td>
            <td>{inf.actor.username}#{inf.actor.discriminator.padStart(4, "0")} ({inf.actor.id})</td>
          </tr>
          <tr>
            <td>Created At</td>
        ...
        columns={[
          ...
          {Header: "User", columns: [
            {Header: "ID", accessor: "user.id", id: "user_id"},
            {
              Header: "Tag",
              id: "user_tag",
              accessor: d => d.user.username + '#' + d.user.discriminator.padStart(4, "0"),
              filterable: false,
              sortable: false,
            }
          ]},
          {Header: "Actor", columns: [
            {Header: "ID", accessor: "actor.id", id: "actor_id"},
            {
              Header: "Tag",
              id: "actor_tag",
              accessor: d => d.actor.username + '#' + d.actor.discriminator.padStart(4, "0"),
              filterable: false,
              sortable: false,
            }
          ]},
