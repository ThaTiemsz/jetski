        ...
        <div className="containerCompactBounded-cYR5cW containerCompact-3V0ioj container-1YxwTf">
          <div className="messageCompact-kQa7ES message-1PNnaP">
            <div className="contentCompact-1QLHBj content-3dzVd8 containerCompact-3pGPJs container-206Blv">
              ...
              <div className="markup-2BOw-j isCompact-1hsne1"><h2 className="headerCompact-3wRt2W"><time className="latin12CompactTimeStamp-3v5WB3 timestampCompact-MHgFLv timestampCompactBase-26h38e" datetime="1499171000611"><i className="separatorLeft-3DZD2Q separator-1xUax1">[</i>2018-12-23 02:08:25 GMT+0<i className="separatorRight-3ctgKv separator-1xUax1">] </i></time><span className=""><span className="username-_4ZSMR" role="button">Tiemen<span className="discriminator">#0001</span></span><i className="separatorRight-3ctgKv separator-1xUax1">: </i></span></h2>I'm sorry, but no. <code className="inline">SELECT name, MIN(date) FROM countdown WHERE status = 'enabled' GROUP BY category ORDER BY date ASC</code> <b>Haha YES!!!</b> <i>haha <b>nope</b></i> <u>yep</u> <s>nope</s></div>
            </div>
            <div className="containerCompact-3bB5aN container-1e22Ot">
              <a className="imageWrapper-2p5ogY imageZoom-1n-ADA clickable-3Ya1ho embedWrapper-3AbfJJ" href="https://cdn.discordapp.com/attachments/209719953706844161/395584117854568448/unknown.png" rel="noreferrer noopener" target="_blank" style={{
                width: '400px',
                height: '268px'
              }}>
                <img src="https://media.discordapp.net/attachments/209719953706844161/395584117854568448/unknown.png?width=400&amp;height=269" style={{
                  width: '400px',
                  height: '268px'
                }} />
              </a>
